...
namespace CursoOnline.DominioTest.Cursos
{
    public class ArmazenadorDeCursoTest
    {
        ...
        {
            var cursoJaSalvo = CursoBuilder.Novo().ComId(432).ComNome(_cursoDto.Nome).Build(); //Setando Id 432
            _cursoRepositorioMock.Setup(r => r.ObterPeloNome(_cursoDto.Nome)).Returns(cursoJaSalvo);//Dto está com Id == 0
        ...
        public void NaoDeveAdicionarNoRepositorioQuandoCursoJaExiste()
        {
            ...
            _cursoRepositorioMock.Verify(r => r.Adicionar(It.IsAny<Curso>()), Times.Never); //Verica que o Adicionar nunca foi chamado
        }
    }
}
