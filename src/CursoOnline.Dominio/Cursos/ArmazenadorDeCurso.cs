    ...
    public class ArmazenadorDeCurso
    {
        ...
        public void Armazenar(CursoDto cursoDto)
        {
            ...
            ValidadorDeRegra.Novo()
                .Quando(cursoJaSalvo != null && cursoJaSalvo.Id != cursoDto.Id, Resource.NomeDoCursoJaExiste)//Só lança exception se Id for diferente de null ou diferente do Id do curso que estou querendo Editar
